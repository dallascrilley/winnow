...
CREATE TABLE "event_types" (
	...
	"hide_calendar_notes" boolean DEFAULT false NOT NULL,
	"success_redirect_url" text,
	"booking_limits" text,
	"lock_time_zone_toggle" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "hashed_links" (
	...
	"used_at" text,
	"created_at" text NOT NULL,
	CONSTRAINT "hashed_links_hash_unique" UNIQUE("hash")
);
--> statement-breakpoint
...
CREATE TABLE "booking_seats" (
	...
	"created_at" text NOT NULL,
	CONSTRAINT "booking_seats_reference_uid_unique" UNIQUE("reference_uid")
);
--> statement-breakpoint
...
CREATE TABLE "bookings" (
	...
	"no_show_host" boolean DEFAULT false NOT NULL,
	"metadata" text,
	"created_at" text NOT NULL,
	"updated_at" text NOT NULL,
	"owner_email" text DEFAULT 'local@localhost' NOT NULL,
...
CREATE TABLE "calendar_cache" (
	...
	"created_at" text NOT NULL,
	CONSTRAINT "calendar_cache_cache_key_unique" UNIQUE("cache_key")
);
--> statement-breakpoint
